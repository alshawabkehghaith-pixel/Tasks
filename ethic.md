...
End Users — Responsible for applying human oversight and using AI outputs within their authorised scope
...
Ad hoc use of general-purpose AI tools (e.g. commercially available chatbots) by individual staff members — this is addressed by a separate acceptable use policy
...
Gate 0 — Ethics Screening (Triggered at: Initiation of any new AI use case)
Activities:
...
Gate 1 — Data and Document Ethics Planning (Triggered at: Data sources and document corpus identified)
Activities:
...
Gate 2 — Model Ethics Review (Triggered at: Trained model or configured RAG pipeline ready for internal evaluation)
Activities:
...
Gate 3 — Pre-Deployment Audit (Triggered at: Model passes functional testing and is ready for UAT)
Activities:
...
Gate 4 — Go-Live Ethics Clearance (Triggered at: UAT passed and production deployment approved)
Activities:
...
Gate 5 — Continuous Monitoring (Triggered at: System is live — ongoing)
Monthly activities:
...
Gate 6 — Decommissioning Review (Triggered at: System is being retired or replaced)
Activities:
...
The following diagram represents the Ethical AI Lifecycle as a continuous governance cycle. The cycle is not linear — operational monitoring feeds back into the build and design phases whenever significant changes are detected.
...
Ethics Screening Record	Gate 0	Ethical AI Officer	Duration of programme + 5 years
Data Ethics Plan	Gate 1	Technical Lead + Data Engineer	Duration of programme + 5 years
Dataset / Corpus Datasheet	Gate 1/2	Data Engineer	Duration of programme + 5 years
Corpus Classification and Representativeness Report	Gate 1	Data Engineer	Duration of programme + 5 years
Bias Audit Report	Gate 2	Technical Lead	Duration of programme + 5 years
Model Card (versioned)	Gate 2 → updated at Gate 4 and quarterly	Technical Lead	Duration of programme + 5 years
Model Ethics Review Report	Gate 2	Ethical AI Officer	Duration of programme + 5 years
Pre-Deployment Ethics Audit Checklist	Gate 3	Technical Lead	Duration of programme + 5 years
Penetration Test Report (classified pipeline)	Gate 3	Security Lead	Duration of programme + 5 years
Decision Classification Matrix	Gate 4	Ethical AI Officer + Domain Expert	Duration of system life + 5 years
Classified Document Ingestion Authorisation	Gate 4	Classification Authority	Duration of system life + 5 years
Go-Live Ethics Clearance	Gate 4	Ethical AI Officer + Senior Sponsor	Duration of system life + 5 years
...
HITL Override Log	Gate 5 (ongoing)	System Administrator	Duration of system life + 5 years
